 ...
 */
class getCategorieEventRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategorieEventRepository' shared autowired service.
     *
     * @return \App\Repository\CategorieEventRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategorieEventRepository.php';

        return $container->privates['App\\Repository\\CategorieEventRepository'] = new \App\Repository\CategorieEventRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
