...
class __TwigTemplate_383aba631b0df13a349fa7cce14c6de1 extends Template
{
    ...
    <div class=\"container\">
        <h2 class=\"mb-4 text-center\">Modifier la Catégorie</h2>
        ...
        yield "
            <div class=\"mb-3\">
                ";
        // line 12
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "nomCategorie", [], "any", false, false, false, 12), 'row');
        yield "
            </div>
            <div class=\"mb-3\">
                ";
        ...
        yield "
            ...
            <div class=\"mb-3\">
                ";
        // line 18
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 18, $this->source); })()), "image", [], "any", false, false, false, 18), 'row');
        yield "
            </div>
...
";
    ...
    {
        return array (  118 => 22,  114 => 21,  108 => 18,  102 => 15,  96 => 12,  91 => 10,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }
...
<div style=\"margin-top: 90px;\">
    <div class=\"container\">
        ...
        {{ form_start(form) }}
            ...
            <button type=\"submit\" class=\"btn btn-success\">Confirmer les modifications</button>
            <a href=\"{{ path('liste_categories') }}\" class=\"btn btn-secondary\">Annuler</a>
        {{ form_end(form) }}
    </div>
</div>
{% endblock %}
